...
namespace RacunarskaGrafika
{
    ...
    /*
    // VERZIJA ZA PRVU KONTROLNU TAČKU
    /// <summary>
    /// Klasa enkapsulira programski kod za učitavanje modela pomoću AssimpNet biblioteke 
    /// i prikazivanje modela uz uslonac na TaoFramework biblioteku.
    /// </summary>
    public class AssimpScene : IDisposable
    {
        #region Attributes
        ...
        /// <summary>
        ///  Osvežavanje scene, koje je potrebno izvršiti nakon izmene Scene objekta.
        /// </summary>
        public void Update()
        {
            // Oslobađanje postojeće DL liste.
            Gl.glDeleteLists(m_modelDL, 1);

            // Kreiranje nove DL liste i iscrtavanje scene. Promenljive stanja se čuvaju pre i restauriraju posle iscrtavanja.
            m_modelDL = Gl.glGenLists(1);
            Gl.glNewList(m_modelDL, Gl.GL_COMPILE);
            RenderNode(m_scene.RootNode);
            Gl.glEndList();
        ...
        /// <summary>
        ///  Učitavanje podataka o sceni iz odgovarajućeg fajla.
        /// </summary>
        private void LoadScene()
        {
            // Instanciranje klase za učitavanje podataka o sceni.
            AssimpImporter importer = new AssimpImporter();

            // Definisanje callback delegata za beleženje poruka u toku učitavanja podataka o sceni.
            LogStream logstream = new LogStream(delegate(String msg, String userData)
            {
                Console.WriteLine(msg);
            });
            ...
            // Oslobađanje resursa korišćenih za učitavanje podataka o sceni.
            importer.Dispose();
        }

        /// <summary>
        ///  Inicijalizacija i podešavanje OpenGL parametara.
        /// </summary>
        private void Initialize()
        {
        ...
        /// <summary>
        ///  Rekurzivna metoda zadužena za iscrtavanje objekata u sceni koji su reprezentovani čvorovima. 
        ///  U zavisnosti od karakteristika objekata podešavaju se odgovarajuće 
        ///  promenjive stanja (GL_LIGHTING, GL_COLOR_MATERIAL, GL_TEXTURE_2D).
        /// </summary>
        /// <param name="node">Čvor koji ce biti iscrtan.</param>
        private void RenderNode(Node node)
        {
            Gl.glPushMatrix();
            ...
            // Rekurzivno iscrtavanje podcvorova datog cvora.
            for (int i = 0; i < node.ChildCount; i++)
            {
                RenderNode(node.Children[i]);
            }
